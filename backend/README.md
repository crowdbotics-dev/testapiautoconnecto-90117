...
## Project Structure
    ...
    ├── testapiautoconnecto_90117  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_90117`
...
2. Clone this repo and `cd testapiautoconnecto_90117`
